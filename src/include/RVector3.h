...
public:
     ...
     */
    RVector3(const RVector3& p1, const RVector3& p2);
     ...
     */
    static RVector3 fromColor(unsigned int color);
     ...
     */
    static float angle(const RVector3& v1, const RVector3& v2);
     ...
     */
    static void add(const RVector3& v1, const RVector3& v2, RVector3* dst);
     ...
     */
    void clamp(const RVector3& min, const RVector3& max);
     ...
     * @param dst A vector to store the result in.
     */
    static void clamp(const RVector3& v, const RVector3& min, const RVector3& max, RVector3* dst);
     ...
     * @param dst A vector to store the result in.
     */
    static void cross(const RVector3& v1, const RVector3& v2, RVector3* dst);
     ...
     */
    static float dot(const RVector3& v1, const RVector3& v2);
     ...
     */
    void normalize(RVector3* dst) const;
     ...
     */
    void set(const RVector3& v);

    /**
     * Sets this vector to the directional vector between the specified points.
     */
    void set(const RVector3& p1, const RVector3& p2);
     ...
     */
    void subtract(const RVector3& v);
     ...
     * @param dst The destination vector.
     */
    static void subtract(const RVector3& v1, const RVector3& v2, RVector3* dst);
     ...
     */
    void smooth(const RVector3& target, float elapsedTime, float responseTime);
     ...
     */
    inline const RVector3 operator+(const RVector3& v) const;
     ...
     */
    inline RVector3& operator+=(const RVector3& v);
     ...
     */
    inline const RVector3 operator-() const;
     ...
     */
    inline const RVector3 operator*(float x) const;
     ...
     */
    inline RVector3& operator*=(float x);
     ...
     */
    inline bool operator<(const RVector3& v) const;
