...
public:
     ...
     */
    RVector4(const RVector4& p1, const RVector4& p2);
     ...
     */
    static RVector4 fromColor(unsigned int color);
     ...
     */
    static float angle(const RVector4& v1, const RVector4& v2);
     ...
     */
    static void add(const RVector4& v1, const RVector4& v2, RVector4* dst);
     ...
     */
    void clamp(const RVector4& min, const RVector4& max);
     ...
     * @param dst A vector to store the result in.
     */
    static void clamp(const RVector4& v, const RVector4& min, const RVector4& max, RVector4* dst);
     ...
     */
    float dot(const RVector4& v) const;
     ...
     */
    static float dot(const RVector4& v1, const RVector4& v2);
     ...
     */
    void normalize(RVector4* dst) const;
     ...
     * @param p2 The second point.
     */
    void set(const RVector4& p1, const RVector4& p2);
     ...
     */
    void subtract(const RVector4& v);
     ...
     * @param dst The destination vector.
     */
    static void subtract(const RVector4& v1, const RVector4& v2, RVector4* dst);
     ...
     */
    inline const RVector4 operator+(const RVector4& v) const;
     ...
     */
    inline RVector4& operator+=(const RVector4& v);
     ...
     */
    inline const RVector4 operator*(float x) const;
     ...
     */
    inline RVector4& operator*=(float x);
     ...
     */
    inline bool operator<(const RVector4& v) const;
