...
public:
    ...
    public:
         ...
         */
        virtual void transformChanged(RTransform* transform, long cookie) = 0;
    };
     ...
     */
    RTransform(const RVector3& scale, const RQuaternion& rotation, const RVector3& translation);
     ...
     * @param translation The translation vector.
     */
    RTransform(const RVector3& scale, const RMatrix& rotation, const RVector3& translation);
     ...
     */
    RTransform(const RTransform& copy);
     ...
     */
    const RQuaternion& getRotation() const;
     ...
     */
    void getRotation(RQuaternion* rotation) const;
     ...
     */
    void getRotation(RMatrix* rotation) const;
     ...
     */
    float getRotation(RVector3* axis) const;

    /**
     * Returns the translation for this transform.
     */
    const RVector3& getTranslation() const;
     ...
     */
    RVector3 getForwardVector() const;
     ...
     */
    void rotate(const RQuaternion& rotation);
     ...
     */
    void rotate(const RMatrix& rotation);
     ...
     * @param translation The translation vector.
     */
    void set(const RVector3& scale, const RQuaternion& rotation, const RVector3& translation);
     ...
     * @param translation The translation vector.
     */
    void set(const RVector3& scale, const RMatrix& rotation, const RVector3& translation);
     ...
     * @param translation The translation vector.
     */
    void set(const RVector3& scale, const RVector3& axis, float angle, const RVector3& translation);
     ...
     */
    void set(const RTransform& transform);
     ...
     */
    void setRotation(const RQuaternion& rotation);
     ...
     */
    void setRotation(const RMatrix& rotation);
     ...
     * @param angle The angle of rotation (in radians).
     */
    void setRotation(const RVector3& axis, float angle);
     ...
     * @param translation The translation vector.
     */
    void setTranslation(const RVector3& translation);
     ...
     */
    void translate(const RVector3& translation);
     ...
     */
    void translateSmooth(const RVector3& target, float elapsedTime, float responseTime);
     ...
     */
    void transformPoint(RVector3* point);
     ...
     */
    void transformPoint(const RVector3& point, RVector3* dst);
     ...
     */
    void transformVector(RVector3* vector);
     ...
     * @param dst The vector to store the result in.
     */
    void transformVector(const RVector3& transformVector, RVector3* dst);
     ...
     * @param dst The vector to store the result in.
     */
    void transformVector(float x, float y, float z, float w, RVector3* dst);
     ...
     */
    void addListener(RTransform::Listener* listener, long cookie = 0);
     ...
     */
    void removeListener(RTransform::Listener* listener);
...
protected:
     ...
     */
    static void suspendTransformChange(RTransform* transform);
     ...
     */
    RQuaternion _rotation;
    
    /** 
     * The translation component of the Transform.
     */
    RVector3 _translation;
    
    /** 
     * The Matrix representation of the Transform.
     */
    mutable RMatrix _matrix;
     ...
     */
    std::list<RTransformListener>* _listeners;
...
private:
    ...
    static std::vector<RTransform*> _transformsChanged;
