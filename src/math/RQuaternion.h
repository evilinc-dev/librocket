...
public:
     ...
     */
    RQuaternion(float x, float y, float z, float w);
     ...
     */
    RQuaternion(const RVector3& axis, float angle);
     ...
     */
    RQuaternion(const RQuaternion& copy);
	...
	*/
	static void createFromEuler(float yaw, float pitch, float roll, RQuaternion* dst);
     ...
     */
    static void createFromRotationMatrix(const RMatrix& m, RQuaternion* dst);
     ...
     * @param dst A quaternion to store the conjugate in.
     */
    static void createFromAxisAngle(const RVector3& axis, float angle, RQuaternion* dst);
	...
	*/
     ...
     * @param dst A quaternion to store the conjugate in.
     */
    void conjugate(RQuaternion* dst) const;
     ...
     * @return true if the inverse can be computed, false otherwise.
     */
    bool inverse(RQuaternion* dst) const;
     ...
     */
    void multiply(const RQuaternion& q);
     ...
     * @param dst A quaternion to store the result in.
     */
    static void multiply(const RQuaternion& q1, const RQuaternion& q2, RQuaternion* dst);
     ...
     * @param dst A quaternion to store the result in.
     */
    void normalize(RQuaternion* dst) const;
	...
	*/
	void rotatePoint(const RVector3& point, RVector3* dst) const;
     ...
     * @param angle The angle of rotation (in radians).
     */
    void set(const RVector3& axis, float angle);
     ...
     */
    float toAxisAngle(RVector3* e) const;
     ...
     * @param dst A quaternion to store the result in.
     */
    static void lerp(const RQuaternion& q1, const RQuaternion& q2, float t, RQuaternion* dst);
     ...
     * @param dst A quaternion to store the result in.
     */
    static void slerp(const RQuaternion& q1, const RQuaternion& q2, float t, RQuaternion* dst);
     ...
     * @param dst A quaternion to store the result in.
     */
    static void squad(const RQuaternion& q1, const RQuaternion& q2, const RQuaternion& s1, const RQuaternion& s2, float t, RQuaternion* dst);
     ...
     */
    inline const RQuaternion operator*(const RQuaternion& q) const;
     ...
     */
    inline RQuaternion& operator*=(const RQuaternion& q);
...
private:
    ...
    static void slerpForSquad(const RQuaternion& q1, const RQuaternion& q2, float t, RQuaternion* dst);
};

}

#include "RQuaternion.inl"
